...
#ifndef _GLOW_BUNDLE_MODEL_LRESNET_QUANT_H
#define _GLOW_BUNDLE_MODEL_LRESNET_QUANT_H
...
//                          Bundle API
// ---------------------------------------------------------------
// Model name: "model_lresnet_quant"
// Total data size: 18944 (bytes)
...
#define MODEL_LRESNET_QUANT_input_2   0
#define MODEL_LRESNET_QUANT_Identity  1536

// Memory sizes (bytes).
#define MODEL_LRESNET_QUANT_CONSTANT_MEM_SIZE     11008
#define MODEL_LRESNET_QUANT_MUTABLE_MEM_SIZE      1600
#define MODEL_LRESNET_QUANT_ACTIVATIONS_MEM_SIZE  6336

// Memory alignment (bytes).
#define MODEL_LRESNET_QUANT_MEM_ALIGN  64

// Bundle entry point (inference function). Returns 0
// for correct execution or some error code otherwise.
int glow_model_lresnet_quant(uint8_t *constantWeight, uint8_t *mutableWeight, uint8_t *activations);
