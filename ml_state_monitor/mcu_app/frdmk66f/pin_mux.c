...
#include "frdm_stbc_agm01_shield.h" //Include sensor shield board header file
...
{
    const port_pin_config_t i2c_scl_config = {/* Internal pull-up resistor is enabled */
                                                   kPORT_PullUp,
    ...
    const port_pin_config_t i2c_sda_config = {/* Internal pull-up resistor is enabled */
                                                   kPORT_PullUp,
                                                   /* Fast slew rate is configured */
                                                   kPORT_FastSlewRate,
                                                   /* Passive filter is disabled */
    ...
    CLOCK_EnableClock(kCLOCK_PortB);
	PORT_SetPinConfig(PORTB, 2U, &i2c_scl_config);
	PORT_SetPinConfig(PORTB, 3U, &i2c_sda_config);
#else
	CLOCK_EnableClock(kCLOCK_PortD);
    PORT_SetPinConfig(PORTD, 8U, &i2c_scl_config);
    PORT_SetPinConfig(PORTD, 9U, &i2c_sda_config);
#endif
}
