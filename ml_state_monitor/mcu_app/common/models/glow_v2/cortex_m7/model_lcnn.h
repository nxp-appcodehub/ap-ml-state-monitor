...
#ifndef _GLOW_BUNDLE_MODEL_LCNN_H
#define _GLOW_BUNDLE_MODEL_LCNN_H
...
//                          Bundle API
// ---------------------------------------------------------------
// Model name: "model_lcnn"
// Total data size: 14720 (bytes)
...
#define MODEL_LCNN_Identity      1536
#define MODEL_LCNN_acceleration  0

// Memory sizes (bytes).
#define MODEL_LCNN_CONSTANT_MEM_SIZE     8576
#define MODEL_LCNN_MUTABLE_MEM_SIZE      1600
#define MODEL_LCNN_ACTIVATIONS_MEM_SIZE  4544

// Memory alignment (bytes).
#define MODEL_LCNN_MEM_ALIGN  64

// Bundle entry point (inference function). Returns 0
// for correct execution or some error code otherwise.
int glow_model_lcnn(uint8_t *constantWeight, uint8_t *mutableWeight, uint8_t *activations);
