...
#ifndef _GLOW_BUNDLE_MODEL_CNN_QUANT_H
#define _GLOW_BUNDLE_MODEL_CNN_QUANT_H
...
#define MODEL_CNN_QUANT_acceleration  0
#define MODEL_CNN_QUANT_Identity      1536

// Memory sizes (bytes).
#define MODEL_CNN_QUANT_CONSTANT_MEM_SIZE     10880
#define MODEL_CNN_QUANT_MUTABLE_MEM_SIZE      1600
#define MODEL_CNN_QUANT_ACTIVATIONS_MEM_SIZE  2176

// Memory alignment (bytes).
#define MODEL_CNN_QUANT_MEM_ALIGN  64

// Bundle entry point (inference function). Returns 0
// for correct execution or some error code otherwise.
int glow_model_cnn_quant(uint8_t *constantWeight, uint8_t *mutableWeight, uint8_t *activations);
