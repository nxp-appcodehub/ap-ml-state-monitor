...
#ifndef _GLOW_BUNDLE_MODEL_MLP_QUANT_H
#define _GLOW_BUNDLE_MODEL_MLP_QUANT_H
...
//                          Bundle API
// ---------------------------------------------------------------
// Model name: "model_mlp_quant"
// Total data size: 8448 (bytes)
...
#define MODEL_MLP_QUANT_input_1   0
#define MODEL_MLP_QUANT_Identity  1536

// Memory sizes (bytes).
#define MODEL_MLP_QUANT_CONSTANT_MEM_SIZE     6400
#define MODEL_MLP_QUANT_MUTABLE_MEM_SIZE      1600
#define MODEL_MLP_QUANT_ACTIVATIONS_MEM_SIZE  448

// Memory alignment (bytes).
#define MODEL_MLP_QUANT_MEM_ALIGN  64

// Bundle entry point (inference function). Returns 0
// for correct execution or some error code otherwise.
int glow_model_mlp_quant(uint8_t *constantWeight, uint8_t *mutableWeight, uint8_t *activations);
