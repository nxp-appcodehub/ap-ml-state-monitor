...
constexpr int kTensorArenaSize = TFLM_TENSOR_ARENA_SIZE_B;
...
status_t MODEL_Init(void)
{
    ...
    const uint8_t *model = TFLM_MODEL_DATA;
    const int model_size = TFLM_MODEL_DATA_LEN;
