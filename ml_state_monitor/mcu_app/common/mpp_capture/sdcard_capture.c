...
#include "limits.h"
#include "..\eiq\mpp\hal\include\hal_utils.h"

/*******************************************************************************
 * Definitions
 ******************************************************************************/
#define SDCARD_MKFS_EN              0               // Enable/Disable MKFS
#define SDCARD_CAPT_TSYNC_US        320000         // The periodicity for capture sync
/*******************************************************************************
 * Variables
 ******************************************************************************/
...
void SDCARD_CaptureData(uint64_t ts_us, uint64_t sample_num, uint64_t totalDuration_samples, char *buf, uint32_t size)
{
    ...
    {
        printf("\rProgress: %.2f%% (%.2f/%ld minutes)          ",
