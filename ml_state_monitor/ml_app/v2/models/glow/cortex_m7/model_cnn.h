...
#ifndef _GLOW_BUNDLE_MODEL_CNN_H
#define _GLOW_BUNDLE_MODEL_CNN_H
...
#define MODEL_CNN_acceleration  0
#define MODEL_CNN_Identity      1536

// Memory sizes (bytes).
#define MODEL_CNN_CONSTANT_MEM_SIZE     41472
#define MODEL_CNN_MUTABLE_MEM_SIZE      1600
#define MODEL_CNN_ACTIVATIONS_MEM_SIZE  8192

// Memory alignment (bytes).
#define MODEL_CNN_MEM_ALIGN  64

// Bundle entry point (inference function). Returns 0
// for correct execution or some error code otherwise.
int glow_model_cnn(uint8_t *constantWeight, uint8_t *mutableWeight, uint8_t *activations);
